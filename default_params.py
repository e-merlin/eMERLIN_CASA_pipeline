...
defaults['bandpass']['delay_minsnr']                  = 5
...
defaults['bandpass']['phase_minsnr']                  = 5
...
defaults['initial_gaincal']['delay']['solint']        = '300s'
...
defaults['initial_gaincal']['delay']['minsnr']        = 5
...
defaults['initial_gaincal']['p_minsnr']               = 3
...
defaults['initial_gaincal']['ap_minblperant']         = 4
defaults['initial_gaincal']['ap_minsnr']              = 3
...
defaults['initial_gaincal']['tfcrop']['timecutoff']   = 4.0
defaults['initial_gaincal']['tfcrop']['freqcutoff']   = 4.0
...
defaults['flag_target']['tfcrop']['sources']          = 'bpcal'
