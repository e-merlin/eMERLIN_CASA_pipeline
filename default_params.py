...
defaults['bandpass']['ap_tablename']                  = 'bpcal_ap.G0'
...
defaults['bandpass']['bp_tablename']                  = 'bpcal.BP0'
...
defaults['bandpass']['bp_prev_cal']                   = ['bpcal_d.K0', 'bpcal_p.G0', 'bpcal_ap.G0']
defaults['bandpass']['apply_calibrators']             = ['bpcal.BP0']
...
defaults['bandpass']['tfcrop']['flagbackup']          = False
defaults['bp_apply_mid'] = collections.OrderedDict()
defaults['bp_apply_mid']['apply_calibrators']         = ['bpcal_d.K0','bpcal_p.G0','bpcal_ap.G0','bpcal.BP0']
...
defaults['initial_gaincal']['delay']['tablename']     = 'allcal_d.K1'
defaults['initial_gaincal']['delay']['delay_cal']     = 'default'
defaults['initial_gaincal']['delay']['solint']        = '180s'
defaults['initial_gaincal']['delay']['combine']       = 'spw'
defaults['initial_gaincal']['delay']['prev_cal']      = ['bpcal.BP0']
...
defaults['initial_gaincal']['p_tablename']            = 'allcal_p.G1'
defaults['initial_gaincal']['p_prev_cal']             = ['bpcal.BP0','allcal_d.K1']
...
defaults['initial_gaincal']['ap_prev_cal']            = ['bpcal.BP0','allcal_d.K1','allcal_p.G1']
defaults['initial_gaincal']['ap_calibrator']          = 'default'
...
defaults['initial_gaincal']['apply_calibrators']      = ['bpcal.BP0','allcal_d.K1','allcal_p.G1','allcal_ap.G1']
...
defaults['initial_gaincal']['tfcrop']['flagbackup']   = False
...
defaults['initial_gaincal']['rflag']['flagbackup']    = False
...
defaults['fluxscale']['apply_calibrators']            = ['bpcal.BP0','allcal_d.K1','allcal_p.G1','allcal_ap.G1_fluxscaled']
defaults['fluxscale']['apply_targets']                = []

defaults['bandpass_final'] = collections.OrderedDict()
defaults['bandpass_final']['bp_tablename']            = 'bpcal.BP2'
defaults['bandpass_final']['bp_prev_cal']             = ['bpcal_d.K0','bpcal_p.G0', 'bpcal_ap.G0']
defaults['bandpass_final']['bp_solint']               = 'inf'
defaults['bandpass_final']['bp_spw']                  = ['*','']
defaults['bandpass_final']['bp_combine']              = 'field,scan'
defaults['bandpass_final']['bp_interp']               = 'nearest,cubicflag'
defaults['bandpass_final']['bp_uvrange']              = ''
defaults['bandpass_final']['bp_fillgaps']             = 8
defaults['bandpass_final']['bp_solnorm']              = True
defaults['bandpass_final']['apply_calibrators']       = ['allcal_d.K0','bpcal_p.G0', 'bpcal_ap.G0','bpcal.BP2']
defaults['bandpass_final']['apply_targets']           = []

defaults['gaincal_final'] = collections.OrderedDict()
defaults['gaincal_final']['p_tablename']            = 'allcal_p.G3'
defaults['gaincal_final']['p_prev_cal']             = ['bpcal.BP2','allcal_d.K1']
defaults['gaincal_final']['p_solint']               = 'int'
defaults['gaincal_final']['p_spw']                  = ['*','innerchan']
defaults['gaincal_final']['p_combine']              = ''
defaults['gaincal_final']['p_interp']               = 'linear'
defaults['gaincal_final']['p_minblperant']          = 3
defaults['gaincal_final']['p_minsnr']               = 2
defaults['gaincal_final']['ap_tablename']           = 'allcal_ap.G3'
defaults['gaincal_final']['ap_prev_cal']            = ['bpcal.BP2','allcal_d.K1','allcal_p.G3']
defaults['gaincal_final']['ap_calibrator']          = 'default'
defaults['gaincal_final']['ap_solint']              = '32s'
defaults['gaincal_final']['ap_spw']                 = ['*','innerchan']
defaults['gaincal_final']['ap_combine']             = ''
defaults['gaincal_final']['ap_interp']              = 'linear'
defaults['gaincal_final']['ap_minblperant']         = 3
defaults['gaincal_final']['ap_minsnr']              = 2
defaults['gaincal_final']['p_scan_tablename']       = 'phscal_p_scan.G3'
defaults['gaincal_final']['p_scan_prev_cal']        = ['bpcal.BP2','allcal_d.K1']
defaults['gaincal_final']['p_scan_solint']          = 'inf'
defaults['gaincal_final']['p_scan_spw']             = ['*','innerchan']
defaults['gaincal_final']['p_scan_combine']         = ''
defaults['gaincal_final']['p_scan_interp']          = 'linear'
defaults['gaincal_final']['p_scan_minblperant']     = 3
defaults['gaincal_final']['p_scan_minsnr']          = 2
defaults['gaincal_final']['ap_scan_tablename']      = 'phscal_ap_scan.G3'
defaults['gaincal_final']['ap_scan_prev_cal']       = ['bpcal.BP2','allcal_d.K1','allcal_p.G3']
defaults['gaincal_final']['ap_scan_calibrator']     = 'default'
defaults['gaincal_final']['ap_scan_solint']         = 'inf'
defaults['gaincal_final']['ap_scan_spw']            = ['*','innerchan']
defaults['gaincal_final']['ap_scan_combine']        = ''
defaults['gaincal_final']['ap_scan_interp']         = 'linear'
defaults['gaincal_final']['ap_scan_minblperant']    = 3
defaults['gaincal_final']['ap_scan_minsnr']         = 2
defaults['gaincal_final']['apply_calibrators']      = ['allcal_d.K1','bpcal.BP2','allcal_p.G3','allcal_ap.G3']
defaults['gaincal_final']['apply_targets']          = ['allcal_d.K1','bpcal.BP2','phscal_p_scan.G3','phscal_ap_scan.G3']
defaults['gaincal_final']['p_offset_tablename']     = 'narrow_p_offset.G3'
defaults['gaincal_final']['p_offset_prev_cal']      = ['allcal_d.K1','allcal_p.G3']
defaults['gaincal_final']['p_offset_solint']        = 'inf'
defaults['gaincal_final']['p_offset_spw']           = ['*','innerchan']
defaults['gaincal_final']['p_offset_combine']       = 'scan'
defaults['gaincal_final']['p_offset_interp']        = 'linear'
defaults['gaincal_final']['p_offset_minblperant']   = 3
defaults['gaincal_final']['p_offset_minsnr']        = 2
defaults['gaincal_final']['narrow_bp_tablename']     = 'narrow_bpcal.BP2'
defaults['gaincal_final']['narrow_bp_prev_cal']      = ['allcal_d.K1','allcal_p.G3','allcal_ap.G3','narrow_p_offset.G3']
defaults['gaincal_final']['narrow_bp_solint']        = 'inf'
defaults['gaincal_final']['narrow_bp_spw']           = ['*','']
defaults['gaincal_final']['narrow_bp_combine']       = 'field,scan'
defaults['gaincal_final']['narrow_bp_interp']        = 'nearest,cubicflag'
defaults['gaincal_final']['narrow_bp_uvrange']       = ''
defaults['gaincal_final']['narrow_bp_fillgaps']      = 8
defaults['gaincal_final']['narrow_bp_solnorm']       = True
defaults['gaincal_final']['narrow_apply_calibrators']= ['allcal_d.K1','narrow_bpcal.BP2','allcal_p.G3','allcal_ap.G3','narrow_p_offset.G3']
defaults['gaincal_final']['narrow_apply_targets']    = ['allcal_d.K1','narrow_bpcal.BP2','phscal_p_scan.G3','phscal_ap_scan.G3','narrow_p_offset.G3']

defaults['applycal_all'] = collections.OrderedDict()
defaults['applycal_all']['apply_calibrators']         = ['allcal_d.K1','bpcal.BP2','allcal_p.G3','allcal_ap.G3']
defaults['applycal_all']['apply_targets']             = ['allcal_d.K1','bpcal.BP2','phscal_p_scan.G3','phscal_ap_scan.G3']
defaults['applycal_all']['apply_narrow_calibrators']  = ['allcal_d.K1','narrow_bpcal.BP2','allcal_p.G3','allcal_ap.G3','narrow_p_offset.G3']
defaults['applycal_all']['apply_narrow_targets']      = ['allcal_d.K1','narrow_bpcal.BP2','phscal_p_scan.G3','phscal_ap_scan.G3','narrow_p_offset.G3']
...
defaults['flag_target']['rflag']['flagbackup']        = False
...
defaults['first_images']['parallel']                  = False
defaults['first_images']['level0']                    = 3.
defaults['first_images']['zoom_range_pix']            = 150
