...
defaults['bandpass']['delay_minsnr']          = 10
...
defaults['bandpass']['phase_minsnr']          = 10
defaults['bandpass']['ap_tablename']          = 'bpcal_ap.G1'
defaults['bandpass']['ap_solint']             = 'int'
...
defaults['bandpass']['ap_minblperant']        = 4
defaults['bandpass']['ap_minsnr']             = 10
...
defaults['bandpass']['flag_tfcrop'] = collections.OrderedDict()
defaults['bandpass']['flag_tfcrop']['mode']               = 'tfcrop'
defaults['bandpass']['flag_tfcrop']['sources']            = 'bpcal'
defaults['bandpass']['flag_tfcrop']['antenna']            = ''
defaults['bandpass']['flag_tfcrop']['scan']               = ''
defaults['bandpass']['flag_tfcrop']['spw']                = ''
defaults['bandpass']['flag_tfcrop']['correlation']        = 'ABS_LL,RR'
defaults['bandpass']['flag_tfcrop']['ntime']              = ''
defaults['bandpass']['flag_tfcrop']['combinescans']       = False
defaults['bandpass']['flag_tfcrop']['datacolumn']         = 'corrected'
defaults['bandpass']['flag_tfcrop']['winsize']            = 3
defaults['bandpass']['flag_tfcrop']['timecutoff']         = 4.5
defaults['bandpass']['flag_tfcrop']['freqcutoff']         = 4.5
defaults['bandpass']['flag_tfcrop']['maxnpieces']         = 7
defaults['bandpass']['flag_tfcrop']['usewindowstats']     = 'none'
defaults['bandpass']['flag_tfcrop']['halfwin']            = 1
defaults['bandpass']['flag_tfcrop']['extendflags']        = True
defaults['bandpass']['flag_tfcrop']['action']             = 'apply'
defaults['bandpass']['flag_tfcrop']['display']            = ''
defaults['bandpass']['flag_tfcrop']['flagbackup']         = True
...
defaults['gain_p_ap']['ap_minblperant']       = 4
...
defaults['gain_p_ap']['rflag'] = collections.OrderedDict()
defaults['gain_p_ap']['rflag']['mode']        = 'rflag'
defaults['gain_p_ap']['rflag']['sources']     = 'calsources'
defaults['gain_p_ap']['rflag']['antenna']     = ''
defaults['gain_p_ap']['rflag']['scan']        = ''
defaults['gain_p_ap']['rflag']['spw']         = ''
defaults['gain_p_ap']['rflag']['correlation'] = 'ABS_LL,RR'
defaults['gain_p_ap']['rflag']['ntime']       = ''
defaults['gain_p_ap']['rflag']['combinescans']= False
defaults['gain_p_ap']['rflag']['datacolumn']  = 'corrected'
defaults['gain_p_ap']['rflag']['timedevscale']= 4.5
defaults['gain_p_ap']['rflag']['freqdevscale']= 4.5
defaults['gain_p_ap']['rflag']['extendflags'] = False
defaults['gain_p_ap']['rflag']['action']      = 'apply'
defaults['gain_p_ap']['rflag']['display']     = ''
defaults['gain_p_ap']['rflag']['flagbackup']  = True
...
defaults['gain_amp_sp']['ap_minblperant']     = 4
defaults['gain_amp_sp']['ap_minsnr']          = 5
...
defaults['gain_amp_sp']['p_scan_minsnr']      = 5
...
defaults['gain_amp_sp']['ap_scan_minblperant']= 4
defaults['gain_amp_sp']['ap_scan_minsnr']     = 5
...
defaults['flag_rflag']['timedevscale']        = 4.5
defaults['flag_rflag']['freqdevscale']        = 4.5
