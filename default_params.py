...
defaults['bandpass']['flag_tfcrop']['timecutoff']         = 4.0
defaults['bandpass']['flag_tfcrop']['freqcutoff']         = 3.0
...
defaults['gain_p_ap']['rflag']['timedevscale']= 4.0
defaults['gain_p_ap']['rflag']['freqdevscale']= 4.0
