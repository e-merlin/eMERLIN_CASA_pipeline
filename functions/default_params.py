...
defaults['fluxscale']['apply_calibrators']   = ['bpcal.B0','delay.K1','allcal_p.G0','allcal_p_jitter.G0','allcal_ap.G1_fluxscaled']
defaults['fluxscale']['apply_targets']       = ['bpcal.B0','delay.K1','allcal_p.G0','allcal_ap.G1_fluxscaled']

defaults['bandpass_sp'] = collections.OrderedDict()
defaults['bandpass_sp']['bp_tablename']       = 'bpcal_sp.B1'
defaults['bandpass_sp']['bp_prev_cal']        = ['delay.K1','allcal_p.G0','allcal_p_jitter.G0','allcal_ap.G1_fluxscaled']
defaults['bandpass_sp']['bp_solint']          = 'inf'
defaults['bandpass_sp']['bp_spw']             = ['*','']
defaults['bandpass_sp']['bp_combine']         = 'field,scan'
defaults['bandpass_sp']['bp_interp']          = 'nearest,linear'
defaults['bandpass_sp']['bp_uvrange']         = ''
defaults['bandpass_sp']['bp_solnorm']         = False
defaults['bandpass_sp']['apply_calibrators']  = ['delay.K1','allcal_p.G0','allcal_p_jitter.G0','allcal_ap.G1_fluxscaled','bpcal_sp.B1']
defaults['bandpass_sp']['apply_targets']      = ['delay.K1','allcal_p.G0','allcal_ap.G1_fluxscaled','bpcal_sp.B1']

defaults['gain_amp_sp'] = collections.OrderedDict()
defaults['gain_amp_sp']['ap_tablename']       = 'allcal_ap.G3'
defaults['gain_amp_sp']['ap_prev_cal']        = ['delay.K1','allcal_p.G0','allcal_p_jitter.G0','bpcal_sp.B1']
...
defaults['gain_amp_sp']['p_scan_prev_cal']    = ['delay.K1','allcal_p_jitter.G0','bpcal_sp.B1']
...
defaults['gain_amp_sp']['ap_scan_prev_cal']   = ['delay.K1','allcal_p_jitter.G0','bpcal_sp.B1','phscal_p_scan.G3']
...
defaults['gain_amp_sp']['apply_calibrators']  = ['delay.K1','allcal_p.G0','allcal_p_jitter.G0','bpcal_sp.B1','allcal_ap.G3']
defaults['gain_amp_sp']['apply_targets']      = ['delay.K1','bpcal_sp.B1','phscal_p_scan.G3','phscal_ap_scan.G3'] 

defaults['applycal_all'] = collections.OrderedDict()
defaults['applycal_all']['apply_calibrators'] = ['delay.K1','allcal_p.G0','allcal_p_jitter.G0','bpcal_sp.B1','allcal_ap.G3']
...
defaults['first_images']['niter'] = 1000
defaults['first_images']['deconvolver'] = 'hogbom'
defaults['first_images']['weighting'] = 'briggs'
defaults['first_images']['robust'] = 0.5
defaults['first_images']['maskthreshold'] = 5.0
defaults['first_images']['maskresolution'] = 1.0
defaults['first_images']['nmask'] = 2
